...
def preprocess_train_data(data: pd.DataFrame) -> pd.DataFrame:
    ...
    data = data.drop(columns=['Unnamed: 0', 'mark', 'model', 'generation_name', 'year', 'mileage', 'vol_engine', 'fuel', 'city', 'province', 'price'],axis=1)
    ...
    with open('C:/Users/Omen/Desktop/ІТСС/RGR/pipeline/settings/modes.pkl', 'wb') as f:
        pickle.dump(modes, f)

    categorical_cols = data.select_dtypes(include='object').columns

    one_hot_cols = ['mark', 'model', 'generation_name', 'fuel', 'city', 'province']
    ...
    with open('C:/Users/Omen/Desktop/ІТСС/RGR/pipeline/settings/onehot_encoder.pkl', 'wb') as f:
        pickle.dump(ohe, f)
    with open('C:/Users/Omen/Desktop/ІТСС/RGR/pipeline/settings/label_encoders.pkl', 'wb') as f:
    ...
    with open('C:/Users/Omen/Desktop/ІТСС/RGR/pipeline/settings/scaler.pkl', 'wb') as f:
...
def preprocess_testing_data(data: pd.DataFrame) -> pd.DataFrame:
    ...
    # handling missing values using mode
    missing_cols = sorted(data.columns[data.isnull().any()].tolist(), key=lambda col: data[col].isnull().sum(), reverse=True)
    with open('C:/Users/Omen/Desktop/ІТСС/RGR/pipeline/settings/modes.pkl', 'rb') as f:
        modes = pickle.load(f)
    ...
    # encoding categorical columns
    with open('C:/Users/Omen/Desktop/ІТСС/RGR/pipeline/settings/label_encoders.pkl', 'rb') as f:
        label_encoders = pickle.load(f)
    with open('C:/Users/Omen/Desktop/ІТСС/RGR/pipeline/settings/onehot_encoder.pkl', 'rb') as f:
        ohe = pickle.load(f)
    ...
    with open('C:/Users/Omen/Desktop/ІТСС/RGR/pipeline/settings/scaler.pkl', 'rb') as f:
